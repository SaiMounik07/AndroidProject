...
class ProductAdapter(private var products: List<Product>): RecyclerView.Adapter<ProductAdapter.ProductViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        if (!product.name.isEmpty()) {
            ...
            holder.ivFreeShippingIcon.visibility =
                if (product.tags.contains("FREE_SHIPPING")) View.VISIBLE else View.GONE
            holder.ivFlashSaleIcon.isVisible = product.tags.contains("FLASH_SALE_CAMPAIGN")
    ...
    class ProductViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        val ivFreeShippingIcon = itemView.findViewById<ImageView>(R.id.free_shipping_logo)
        val ivFlashSaleIcon= itemView.findViewById<ImageView>(R.id.iv_flashsale)
